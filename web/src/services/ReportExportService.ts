...
<p><small>Generated by API AC Scanner V3.2. Secrets are excluded or redacted. Findings are evidence for authorized review, not proof of complete security.</small></p>
</body></html>`;
}
